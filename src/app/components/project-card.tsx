    ...
    if (id === 3) {
        return (
            <div ref={cardRef} className="h-dvh w-full flex items-end justify-center sticky top-0">
                ...
                >
                    {id === 3 &&
                        <p className="text-background text-3xl">D'autres projets sont en cours de création...</p>
                    }
                </motion.div>
            </div>
        )
