                    ...
                    <div className="h-[150dvh] w-full">
                        ...
                        <div className="sticky top-0 flex items-center justify-evenly h-dvh w-full max-md:flex-col">
                            <div className="flex flex-col text-background lg:text-8xl font-bold uppercase text-7xl">
                                <motion.div initial={{ opacity: 0,  y: media !== "sm" ? "150%" : "-600%" }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} onClick={() => setSelectedSkill(1)}>
                                    <AnimatedText>Figma</AnimatedText>
                                </motion.div>
                                <motion.div initial={{ opacity: 0, y: media !== "sm" ? "300%" : "-450%" }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} onClick={() => setSelectedSkill(2)}>
                                    <AnimatedText>Github</AnimatedText>
                                </motion.div>
                                <motion.div initial={{ opacity: 0, y: media !== "sm" ? "450%" : "-300%"  }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} onClick={() => setSelectedSkill(3)}>
                                    <AnimatedText>Slack</AnimatedText>
                                </motion.div>
                                <motion.div initial={{ opacity: 0, y: media !== "sm" ? "600%" : "-150%"  }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} onClick={() => setSelectedSkill(4)}>
