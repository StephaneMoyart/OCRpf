...
export const Footer = () => {
    ...
    return (
        <>
            <div className="relative h-[50dvh] bg-foreground">
                <motion.div
                    style={{ scaleX, borderRadius }}
                    ref={ref} 
                    className="h-full bg-background"
                >
                    <motion.h2 style={{ opacity }} className="text-6xl md:text-9xl uppercase absolute left-1/2 max-md:transform max-md:-translate-x-1/2 bottom-14 md:left-14">Contact</motion.h2>
                </motion.div>
            </div>
            <div className="relative h-[650px]" style={{ clipPath: "polygon(0% 0, 100% 0, 100% 100%, 0 100%)"}}>
                <div className="flex flex-col fixed h-[650px] w-full bottom-0 bg-foreground text-background px-24">
                    ...
                    <div className="flex w-full h-1/5 items-center text-2xl max-md:flex-col max-md:justify-evenly max-md:text-xl md:justify-between">
                        ...
                        <p className="max-md:w-[200px]">© 2025 Tous droits réservés.</p>
                    </div>
                </div>
            </div>
        </>
